...
export type ThumbsDownRegularSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ThumbsDownRegularSvgIcon(props: ThumbsDownRegularSvgIconProps) {
...
export default ThumbsDownRegularSvgIcon;
/* prettier-ignore-end */
